...
class CacheConfiguration(
    ...
    fun hibernatePropertiesCustomizer(cm: javax.cache.CacheManager) = HibernatePropertiesCustomizer {
        props ->
        props[ConfigSettings.CACHE_REGION_FACTORY] = cm
    }
    ...
    fun cacheManagerCustomizer(jcacheConfiguration: javax.cache.configuration.Configuration<Any, Any>): JCacheManagerCustomizer {
        return JCacheManagerCustomizer {
            ...
            createCache(it, com.mycompany.myapp.domain.User::class.java.name, jcacheConfiguration)
            createCache(it, com.mycompany.myapp.domain.Authority::class.java.name, jcacheConfiguration)
            createCache(it, com.mycompany.myapp.domain.User::class.java.name + ".authorities", jcacheConfiguration)
